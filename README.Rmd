...
### keras/keras-gpu
[rocker/tensorflow <i class="fa fa-external-link"></i>](https://hub.docker.com/r/rocker/tensorflow){target="_blank" title="DockerHub"}, [rocker/tensorflow-gpu <i class="fa fa-external-link"></i>](https://hub.docker.com/r/rocker/tensorflow-gpu){target="_blank" title="DockerHub"} をベースに`kmetrics/blogdown`と同じパッケージ群をインストールしています。

　  

### ml/ml-gpu
[rocker/ml <i class="fa fa-external-link"></i>](https://hub.docker.com/r/rocker/ml){target="_blank" title="DockerHub"}, [rocker/ml-gpu <i class="fa fa-external-link"></i>](https://hub.docker.com/r/rocker/ml-gpu){target="_blank" title="DockerHub"} をベースに`kmetrics/blogdown`と同じパッケージ群をインストールしています。
