...
base image/tag             | build     | build image/tag            | Dockerfile
---------------------------|-----------|----------------------------|------------
rocker/verse:3.6.1         | automated | kmetrics/jverse:latest     | Dockerfile
kmetrics/jverse:latest     | automated | kmetrics/mlwr:latest       | Dockerfile
kmetrics/mlwr:latest       | automated | kmetrics/tidymodels:3.6.1  | Dockerfile
kmetrics/tidymodels:3.6.1  | local     | kmetrics/tidymodels:latest | Dockerfile.full
kmetrics/tidymodels:3.6.1  | automated | kmetrics/blogdown:3.6.1    | Dockerfile
kmetrics/tidymodels:latest | automated | kmetrics/blogdown:latest   | Dockerfile.full
rocker/keras:3.6.1         | automated | kmetrics/keras:3.6.1       | Dockerfile
kmetrics/keras:3.6.1       | local     | kmetrics/keras:latest      | Dockerfile.full
rocker/keras-gpu:3.6.0     | automated | kmetrics/keras-gpu:3.6.0   | Dockerfile
kmetrics/keras-gpu:3.6.0   | local     | kmetrics/keras-gpu:latest  | Dockerfile.full
